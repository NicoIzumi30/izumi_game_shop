<?php 
    ...
    if (isset($_POST['bayar'])) {
        ...
        $insert = "INSERT INTO customer (nama_customer, telp_customer, catatan) VALUES ('$nama','$telp','$catatan')";
        ...
        if ($result) {
           ...
           $qty = $_POST['qty'];
           $id = $_POST['id'];
           $penjualan = "INSERT INTO penjualan (qty_penjualan, id_akun, id_customer) VALUES ('$qty','$id', '$customer_id') ";
